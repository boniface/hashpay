...
window,touch:"ontouchend"in document,cssTransitions:"WebKitTransitionEvent"in window,pushState:"pushState"in history&&"replaceState"in history,mediaquery:a.mobile.media("only all"),cssPseudoElement:!!b("content"),boxShadow:!!b("boxShadow")&&!h,scrollTop:("pageXOffset"in window||"scrollTop"in document.documentElement||"scrollTop"in c[0])&&!g,dynamicBaseTag:function(){var b=location.protocol+"//"+location.host+location.pathname+"ui-dir/",f=a("head base"),d=null,e="",g;f.length?e=f.attr("href"):f=d=
a("<base>",{href:b}).appendTo("head");g=a("<a href='testurl'></a>").prependTo(c)[0].href;f[0].href=e?e:location.pathname;d&&d.remove();return g.indexOf(b)===0}(),eventCapture:"addEventListener"in document});c.remove();g=function(){var a=window.navigator.userAgent;return a.indexOf("Nokia")>-1&&(a.indexOf("Symbian/3")>-1||a.indexOf("Series60/5")>-1)&&a.indexOf("AppleWebKit")>-1&&a.match(/(BrowserNG|NokiaBrowser)\/7\.[0-3]/)}();a.mobile.ajaxBlacklist=window.blackberry&&!window.WebKitPoint||window.operamini&&
...
(function(a,d,b,c){function f(a){for(;a&&typeof a.originalEvent!=="undefined";)a=a.originalEvent;return a}function e(c){for(var b={},f,d;c;){f=a.data(c,m);for(d in f)if(f[d])b[d]=b.hasVirtualBinding=!0;c=c.parentNode}return b}function g(){v&&(clearTimeout(v),v=0);v=setTimeout(function(){C=v=0;A.length=0;w=!1;t=!0},a.vmouse.resetTimerDuration)}function h(b,d,t){var e,g;if(!(g=t&&t[b])){if(t=!t)a:{for(t=d.target;t;){if((g=a.data(t,m))&&(!b||g[b]))break a;t=t.parentNode}t=null}g=t}if(g){e=d;var t=e.type,
i,B;e=a.Event(e);e.type=b;g=e.originalEvent;i=a.event.props;if(g)for(B=i.length;B;)b=i[--B],e[b]=g[b];if(t.search(/^touch/)!==-1&&(b=f(g),t=b.touches,b=b.changedTouches,t=t&&t.length?t[0]:b&&b.length?b[0]:c)){g=0;for(len=z.length;g<len;g++)b=z[g],e[b]=t[b]}a(d.target).trigger(e)}return e}function j(c){var b=a.data(c.target,x);if(!w&&(!C||C!==b))if(b=h("v"+c.type,c))b.isDefaultPrevented()&&c.preventDefault(),b.isPropagationStopped()&&c.stopPropagation(),b.isImmediatePropagationStopped()&&c.stopImmediatePropagation()}
function k(c){var b=f(c).touches,d;if(b&&b.length===1&&(d=c.target,b=e(d),b.hasVirtualBinding))C=F++,a.data(d,x,C),v&&(clearTimeout(v),v=0),p=t=!1,d=f(c).touches[0],y=d.pageX,u=d.pageY,h("vmouseover",c,b),h("vmousedown",c,b)}function o(a){t||(p||h("vmousecancel",a,e(a.target)),p=!0,g())}function r(c){if(!t){var b=f(c).touches[0],d=p,i=a.vmouse.moveDistanceThreshold;p=p||Math.abs(b.pageX-y)>i||Math.abs(b.pageY-u)>i;flags=e(c.target);p&&!d&&h("vmousecancel",c,flags);h("vmousemove",c,flags);g()}}function n(a){if(!t){t=
!0;var c=e(a.target),b;h("vmouseup",a,c);if(!p&&(b=h("vclick",a,c))&&b.isDefaultPrevented())b=f(a).changedTouches[0],A.push({touchID:C,x:b.clientX,y:b.clientY}),w=!0;h("vmouseout",a,c);p=!1;g()}}function l(c){var c=a.data(c,m),b;if(c)for(b in c)if(c[b])return!0;return!1}function i(){}function q(c){var b=c.substr(1);return{setup:function(){l(this)||a.data(this,m,{});a.data(this,m)[c]=!0;s[c]=(s[c]||0)+1;s[c]===1&&D.bind(b,j);a(this).bind(b,i);if(B)s.touchstart=(s.touchstart||0)+1,s.touchstart===1&&
D.bind("touchstart",k).bind("touchend",n).bind("touchmove",r).bind("scroll",o)},teardown:function(){--s[c];s[c]||D.unbind(b,j);B&&(--s.touchstart,s.touchstart||D.unbind("touchstart",k).unbind("touchmove",r).unbind("touchend",n).unbind("scroll",o));var d=a(this),f=a.data(this,m);f&&(f[c]=!1);d.unbind(b,i);l(this)||d.removeData(m)}}}var m="virtualMouseBindings",x="virtualTouchID",d="vmouseover vmousedown vmousemove vmouseup vclick vmouseout vmousecancel".split(" "),z="clientX clientY pageX pageY screenX screenY".split(" "),
s={},v=0,y=0,u=0,p=!1,A=[],w=!1,t=!1,B=a.support.eventCapture,D=a(b),F=1,C=0;a.vmouse={moveDistanceThreshold:10,clickDistanceThreshold:10,resetTimerDuration:1500};for(var E=0;E<d.length;E++)a.event.special[d[E]]=q(d[E]);B&&b.addEventListener("click",function(c){var b=A.length,d=c.target,f,t,e,g,i;if(b){f=c.clientX;t=c.clientY;threshold=a.vmouse.clickDistanceThreshold;for(e=d;e;){for(g=0;g<b;g++)if(i=A[g],e===d&&Math.abs(i.x-f)<threshold&&Math.abs(i.y-t)<threshold||a.data(e,x)===i.touchID){c.preventDefault();
...
e){f=e;c(d,f?"scrollstart":"scrollstop",a)}var d=this,f,e;a(d).bind("touchmove scroll",function(c){a.event.special.scrollstart.enabled&&(f||b(c,!0),clearTimeout(e),e=setTimeout(function(){b(c,!1)},50))})}};a.event.special.tap={setup:function(){var b=this,d=a(b);d.bind("vmousedown",function(f){function e(){clearTimeout(q)}function g(){e();d.unbind("vclick",h).unbind("vmouseup",e).unbind("vmousecancel",g)}function h(a){g();i==a.target&&c(b,"tap",a)}if(f.which&&f.which!==1)return!1;var i=f.target,q;
d.bind("vmousecancel",g).bind("vmouseup",e).bind("vclick",h);q=setTimeout(function(){c(b,"taphold",a.Event("taphold"))},750)})}};a.event.special.swipe={scrollSupressionThreshold:10,durationThreshold:1E3,horizontalDistanceThreshold:30,verticalDistanceThreshold:75,setup:function(){var c=a(this);c.bind(e,function(d){function f(c){if(n){var b=c.originalEvent.touches?c.originalEvent.touches[0]:c;l={time:(new Date).getTime(),coords:[b.pageX,b.pageY]};Math.abs(n.coords[0]-l.coords[0])>a.event.special.swipe.scrollSupressionThreshold&&
c.preventDefault()}}var e=d.originalEvent.touches?d.originalEvent.touches[0]:d,n={time:(new Date).getTime(),coords:[e.pageX,e.pageY],origin:a(d.target)},l;c.bind(h,f).one(g,function(){c.unbind(h,f);n&&l&&l.time-n.time<a.event.special.swipe.durationThreshold&&Math.abs(n.coords[0]-l.coords[0])>a.event.special.swipe.horizontalDistanceThreshold&&Math.abs(n.coords[1]-l.coords[1])<a.event.special.swipe.verticalDistanceThreshold&&n.origin.trigger("swipe").trigger(n.coords[0]>l.coords[0]?"swipeleft":"swiperight");
n=l=b})})}};(function(a,c){function b(){var a=f();a!==e&&(e=a,d.trigger("orientationchange"))}var d=a(c),f,e;a.event.special.orientationchange={setup:function(){if(a.support.orientation)return!1;e=f();d.bind("throttledresize",b)},teardown:function(){if(a.support.orientation)return!1;d.unbind("throttledresize",b)},add:function(a){var c=a.handler;a.handler=function(a){a.orientation=f();return c.apply(this,arguments)}}};a.event.special.orientationchange.orientation=f=function(){var a=document.documentElement;
...
a.noop)}}})})(jQuery,this);
(function(a,d,b){function c(a){a=a||location.href;return"#"+a.replace(/^[^#]*#?(.*)$/,"$1")}var f="hashchange",e=document,g,h=a.event.special,j=e.documentMode,k="on"+f in d&&(j===b||j>7);a.fn[f]=function(a){return a?this.bind(f,a):this.trigger(f)};a.fn[f].delay=50;h[f]=a.extend(h[f],{setup:function(){if(k)return!1;a(g.start)},teardown:function(){if(k)return!1;a(g.stop)}});g=function(){function g(){var b=c(),e=m(j);if(b!==j)q(j=b,e),a(d).trigger(f);else if(e!==j)location.href=location.href.replace(/#.*/,
"")+e;n=setTimeout(g,a.fn[f].delay)}var h={},n,j=c(),i=function(a){return a},q=i,m=i;h.start=function(){n||g()};h.stop=function(){n&&clearTimeout(n);n=b};a.browser.msie&&!k&&function(){var b,d;h.start=function(){if(!b)d=(d=a.fn[f].src)&&d+c(),b=a('<iframe tabindex="-1" title="empty"/>').hide().one("load",function(){d||q(c());g()}).attr("src",d||"javascript:0").insertAfter("body")[0].contentWindow,e.onpropertychange=function(){try{if(event.propertyName==="title")b.document.title=e.title}catch(a){}}};
h.stop=i;m=function(){return c(b.location.href)};q=function(c,d){var g=b.document,i=a.fn[f].domain;if(c!==d)g.title=e.title,g.open(),i&&g.write('<script>document.domain="'+i+'"<\/script>'),g.close(),b.location.hash=c}}();return h}()})(jQuery,this);(function(a){a.widget("mobile.page",a.mobile.widget,{options:{theme:"c",domCache:!1},_create:function(){this._trigger("beforecreate");this.element.addClass("ui-page ui-body-"+this.options.theme)}})})(jQuery);
(function(a,d){a.extend(a.mobile,{ns:"",subPageUrlKey:"ui-page",activePageClass:"ui-page-active",activeBtnClass:"ui-btn-active",ajaxEnabled:!0,hashListeningEnabled:!0,defaultPageTransition:"slide",minScrollBack:screen.height/2,defaultDialogTransition:"pop",loadingMessage:"loading",pageLoadErrorMessage:"Error Loading Page",autoInitializePage:!0,pushStateEnabled:!0,gradeA:function(){return a.support.mediaquery||a.mobile.browser.ie&&a.mobile.browser.ie>=7},keyCode:{ALT:18,BACKSPACE:8,CAPS_LOCK:20,COMMA:188,
...
{x:0,y:c})},20);setTimeout(function(){a.event.special.scrollstart.enabled=!0},150)},nsNormalize:function(c){if(c)return a.camelCase(a.mobile.ns+c)}});a.fn.jqmData=function(c,b){return this.data(c?a.mobile.nsNormalize(c):c,b)};a.jqmData=function(c,b,d){return a.data(c,a.mobile.nsNormalize(b),d)};a.fn.jqmRemoveData=function(c){return this.removeData(a.mobile.nsNormalize(c))};a.jqmRemoveData=function(c,b){return a.removeData(c,a.mobile.nsNormalize(b))};a.jqmHasData=function(c,b){return a.hasData(c,a.mobile.nsNormalize(b))};
var b=a.find;a.find=function(c,d,e,g){c=c.replace(/:jqmData\(([^)]*)\)/g,"[data-"+(a.mobile.ns||"")+"$1]");return b.call(this,c,d,e,g)};a.extend(a.find,b);a.find.matches=function(c,b){return a.find(c,null,null,b)};a.find.matchesSelector=function(c,b){return a.find(b,null,null,[c]).length>0}})(jQuery,this);
(function(a,d){function b(a){var b=a.jqmData("lastClicked");b&&b.length?b.focus():(b=a.find(".ui-title:eq(0)"),b.length?b.focus():a.find(x).eq(0).focus())}function c(b){q&&(!q.closest(".ui-page-active").length||b)&&q.removeClass(a.mobile.activeBtnClass);q=null}function f(){s=!1;z.length>0&&a.mobile.changePage.apply(null,z.pop())}function e(c,d,f,e){var i=a.support.scrollTop?r.scrollTop():!0,h=c.data("lastScroll")||a.mobile.defaultHomeScroll,s=g();i&&window.scrollTo(0,a.mobile.defaultHomeScroll);h<
a.mobile.minScrollBack&&(h=0);d&&(d.height(s+i).jqmData("lastScroll",i).jqmData("lastClicked",q),d.data("page")._trigger("beforehide",null,{nextPage:c}));c.height(s+h).data("page")._trigger("beforeshow",null,{prevPage:d||a("")});a.mobile.hidePageLoadingMsg();f=(a.mobile.transitionHandlers[f||"none"]||a.mobile.defaultTransitionHandler)(f,e,c,d);f.done(function(){c.height("");h?(a.mobile.silentScroll(h),a(document).one("silentscroll",function(){b(c)})):b(c);d&&d.height("").data("page")._trigger("hide",
null,{nextPage:c});c.data("page")._trigger("show",null,{prevPage:d||a("")})});return f}function g(){var b=jQuery.event.special.orientationchange.orientation()==="portrait",c=b?screen.availHeight:screen.availWidth,b=Math.max(b?480:320,a(window).height());return Math.min(c,b)}function h(){a("."+a.mobile.activePageClass).css("min-height",g())}function j(b,c){c&&b.attr("data-"+a.mobile.ns+"role",c);b.page()}function k(a){for(;a;){if(a.nodeName.toLowerCase()=="a")break;a=a.parentNode}return a}function o(b){var b=
a(b).closest(".ui-page").jqmData("url"),c=p.hrefNoHash;if(!b||!i.isPath(b))b=c;return i.makeUrlAbsolute(b,c)}var r=a(window),n=a("html"),l=a("head"),i={urlParseRE:/^(((([^:\/#\?]+:)?(?:\/\/((?:(([^:@\/#\?]+)(?:\:([^:@\/#\?]+))?)@)?(([^:\/#\?\]\[]+|\[[^\/\]@#?]+\])(?:\:([0-9]+))?))?)?)?((\/?(?:[^\/\?#]+\/+)*)([^\?#]*)))?(\?[^#]+)?)(#.*)?/,parseUrl:function(b){if(a.type(b)==="object")return b;var b=i.urlParseRE.exec(b),c;b&&(c={href:b[0]||"",hrefNoHash:b[1]||"",hrefNoSearch:b[2]||"",domain:b[3]||"",
protocol:b[4]||"",authority:b[5]||"",username:b[7]||"",password:b[8]||"",host:b[9]||"",hostname:b[10]||"",port:b[11]||"",pathname:b[12]||"",directory:b[13]||"",filename:b[14]||"",search:b[15]||"",hash:b[16]||""});return c||{}},makePathAbsolute:function(a,b){if(a&&a.charAt(0)==="/")return a;for(var a=a||"",c=(b=b?b.replace(/^\/|(\/[^\/]*|[^\/]+)$/g,""):"")?b.split("/"):[],d=a.split("/"),f=0;f<d.length;f++){var e=d[f];switch(e){case ".":break;case "..":c.length&&c.pop();break;default:c.push(e)}}return"/"+
c.join("/")},isSameDomain:function(a,b){return i.parseUrl(a).domain===i.parseUrl(b).domain},isRelativeUrl:function(a){return i.parseUrl(a).protocol===""},isAbsoluteUrl:function(a){return i.parseUrl(a).protocol!==""},makeUrlAbsolute:function(a,b){if(!i.isRelativeUrl(a))return a;var c=i.parseUrl(a),d=i.parseUrl(b),f=c.protocol||d.protocol,e=c.authority||d.authority,g=c.pathname!=="",h=i.makePathAbsolute(c.pathname||d.filename,d.pathname);return f+"//"+e+h+(c.search||!g&&d.search||"")+c.hash},addSearchParams:function(b,
c){var d=i.parseUrl(b),f=typeof c==="object"?a.param(c):c,e=d.search||"?";return d.hrefNoSearch+e+(e.charAt(e.length-1)!=="?"?"&":"")+f+(d.hash||"")},convertUrlToDataUrl:function(a){var b=i.parseUrl(a);if(i.isEmbeddedPage(b))return b.hash.split(v)[0].replace(/^#/,"");else if(i.isSameDomain(b,p))return b.hrefNoHash.replace(p.domain,"");return a},get:function(a){if(a===d)a=location.hash;return i.stripHash(a).replace(/[^\/]*\.[^\/*]+$/,"")},getFilePath:function(b){var c="&"+a.mobile.subPageUrlKey;return b&&
b.split(c)[0].split(v)[0]},set:function(a){location.hash=a},isPath:function(a){return/\//.test(a)},clean:function(a){return a.replace(p.domain,"")},stripHash:function(a){return a.replace(/^#/,"")},cleanHash:function(a){return i.stripHash(a.replace(/\?.*$/,"").replace(v,""))},isExternal:function(a){a=i.parseUrl(a);return a.protocol&&a.domain!==u.domain?!0:!1},hasProtocol:function(a){return/^(:?\w+:)/.test(a)},isEmbeddedPage:function(a){a=i.parseUrl(a);if(a.protocol!=="")return a.hash&&(a.hrefNoHash===
u.hrefNoHash||A&&a.hrefNoHash===p.hrefNoHash);return/^#/.test(a.href)}},q=null,m={stack:[],activeIndex:0,getActive:function(){return m.stack[m.activeIndex]},getPrev:function(){return m.stack[m.activeIndex-1]},getNext:function(){return m.stack[m.activeIndex+1]},addNew:function(a,b,c,d,f){m.getNext()&&m.clearForward();m.stack.push({url:a,transition:b,title:c,pageUrl:d,role:f});m.activeIndex=m.stack.length-1},clearForward:function(){m.stack=m.stack.slice(0,m.activeIndex+1)},directHashChange:function(b){var c,
f,e;this.getActive();a.each(m.stack,function(a,d){b.currentUrl===d.url&&(c=a<m.activeIndex,f=!c,e=a)});this.activeIndex=e!==d?e:this.activeIndex;c?(b.either||b.isBack)(!0):f&&(b.either||b.isForward)(!1)},ignoreNextHashChange:!1},x="[tabindex],a,button:visible,select:visible,input",z=[],s=!1,v="&ui-state=dialog",y=l.children("base"),u=i.parseUrl(location.href),p=y.length?i.parseUrl(i.makeUrlAbsolute(y.attr("href"),u.href)):u,A=u.hrefNoHash!==p.hrefNoHash,w=a.support.dynamicBaseTag?{element:y.length?
y:a("<base>",{href:p.hrefNoHash}).prependTo(l),set:function(a){w.element.attr("href",i.makeUrlAbsolute(a,p))},reset:function(){w.element.attr("href",p.hrefNoHash)}}:d;a.fn.animationComplete=function(b){return a.support.cssTransitions?a(this).one("webkitAnimationEnd",b):(setTimeout(b,0),a(this))};a.mobile.updateHash=i.set;a.mobile.path=i;a.mobile.base=w;a.mobile.urlstack=m.stack;a.mobile.urlHistory=m;a.mobile.dialogHashKey=v;a.mobile.noneTransitionHandler=function(b,c,d,f){f&&f.removeClass(a.mobile.activePageClass);
d.addClass(a.mobile.activePageClass);return a.Deferred().resolve(b,c,d,f).promise()};a.mobile.defaultTransitionHandler=a.mobile.noneTransitionHandler;a.mobile.transitionHandlers={none:a.mobile.defaultTransitionHandler};a.mobile.allowCrossDomainPages=!1;a.mobile.getDocumentUrl=function(b){return b?a.extend({},u):u.href};a.mobile.getDocumentBase=function(b){return b?a.extend({},p):p.href};a.mobile.loadPage=function(b,c){var f=a.Deferred(),e=a.extend({},a.mobile.loadPage.defaults,c),g=null,h=null,s=
i.makeUrlAbsolute(b,a.mobile.activePage&&o(a.mobile.activePage)||p.hrefNoHash);if(e.data&&e.type==="get")s=i.addSearchParams(s,e.data),e.data=d;var n=i.getFilePath(s),m=i.convertUrlToDataUrl(s);e.pageContainer=e.pageContainer||a.mobile.pageContainer;g=e.pageContainer.children(":jqmData(url='"+m+"')");w&&w.reset();if(g.length){if(!e.reloadPage)return j(g,e.role),f.resolve(s,c,g),f.promise();h=g}if(e.showLoadMsg)var l=setTimeout(function(){a.mobile.showPageLoadingMsg()},e.loadMsgDelay);!a.mobile.allowCrossDomainPages&&
!i.isSameDomain(u,s)?f.reject(s,c):a.ajax({url:n,type:e.type,data:e.data,dataType:"html",success:function(d){var k=a("<div></div>"),q=d.match(/<title[^>]*>([^<]*)/)&&RegExp.$1,v=RegExp("\\bdata-"+a.mobile.ns+"url=[\"']?([^\"'>]*)[\"']?");RegExp(".*(<[^>]+\\bdata-"+a.mobile.ns+"role=[\"']?page[\"']?[^>]*>).*").test(d)&&RegExp.$1&&v.test(RegExp.$1)&&RegExp.$1&&(b=n=i.getFilePath(RegExp.$1));w&&w.set(n);k.get(0).innerHTML=d;g=k.find(":jqmData(role='page'), :jqmData(role='dialog')").first();g.length||
(g=a("<div data-"+a.mobile.ns+"role='page'>"+d.split(/<\/?body[^>]*>/gmi)[1]+"</div>"));q&&!g.jqmData("title")&&g.jqmData("title",q);if(!a.support.dynamicBaseTag){var o=i.get(n);g.find("[src], link[href], a[rel='external'], :jqmData(ajax='false'), a[target]").each(function(){var b=a(this).is("[href]")?"href":a(this).is("[src]")?"src":"action",c=a(this).attr(b),c=c.replace(location.protocol+"//"+location.host+location.pathname,"");/^(\w+:|#|\/)/.test(c)||a(this).attr(b,o+c)})}g.attr("data-"+a.mobile.ns+
"url",i.convertUrlToDataUrl(n)).appendTo(e.pageContainer);g.one("pagecreate",function(){g.data("page").options.domCache||g.bind("pagehide.remove",function(){a(this).remove()})});j(g,e.role);s.indexOf("&"+a.mobile.subPageUrlKey)>-1&&(g=e.pageContainer.children(":jqmData(url='"+m+"')"));e.showLoadMsg&&(clearTimeout(l),a.mobile.hidePageLoadingMsg());f.resolve(s,c,g,h)},error:function(){w&&w.set(i.get());e.showLoadMsg&&(clearTimeout(l),a.mobile.hidePageLoadingMsg(),a("<div class='ui-loader ui-overlay-shadow ui-body-e ui-corner-all'><h1>"+
a.mobile.pageLoadErrorMessage+"</h1></div>").css({display:"block",opacity:0.96,top:r.scrollTop()+100}).appendTo(e.pageContainer).delay(800).fadeOut(400,function(){a(this).remove()}));f.reject(s,c)}});return f.promise()};a.mobile.loadPage.defaults={type:"get",data:d,reloadPage:!1,role:d,showLoadMsg:!1,pageContainer:d,loadMsgDelay:50};a.mobile.changePage=function(b,g){if(typeof g!=="object"){var h=null;if(typeof b==="object"&&b.url&&b.type)h={type:b.type,data:b.data,forcePageLoad:!0},b=b.url;var l=
arguments.length;if(l>1){var k=["transition","reverse","changeHash","fromHashChange"],q;for(q=1;q<l;q++){var o=arguments[q];typeof o!=="undefined"&&(h=h||{},h[k[q-1]]=o)}}if(h)return a.mobile.changePage(b,h)}if(s)z.unshift(arguments);else{s=!0;var p=a.extend({},a.mobile.changePage.defaults,g);p.pageContainer=p.pageContainer||a.mobile.pageContainer;if(typeof b=="string")a.mobile.loadPage(b,p).done(function(b,c,d,f){s=!1;c.duplicateCachedPage=f;a.mobile.changePage(d,c)}).fail(function(){s=!1;c(!0);
f();p.pageContainer.trigger("changepagefailed")});else{var u=p.pageContainer,h=a.mobile.activePage,k=l=b.jqmData("url");i.getFilePath(l);q=m.getActive();var o=m.activeIndex===0,r=0,y=document.title,x=p.role==="dialog"||b.jqmData("role")==="dialog";u.trigger("beforechangepage");if(h&&h[0]===b[0])s=!1,u.trigger("changepage");else{j(b,p.role);p.fromHashChange&&m.directHashChange({currentUrl:l,isBack:function(){r=-1},isForward:function(){r=1}});try{a(document.activeElement||"").add("input:focus, textarea:focus, select:focus").blur()}catch(w){}x&&
q&&(l=(q.url||"")+v);if(p.changeHash!==!1&&l)m.ignoreNextHashChange=!0,i.set(l);var A=b.jqmData("title")||b.children(":jqmData(role='header')").find(".ui-title").text();A&&y==document.title&&(y=A);r||m.addNew(l,p.transition,y,k,p.role);document.title=m.getActive().title;a.mobile.activePage=b;p.transition=p.transition||(r&&!o?q.transition:d)||(x?a.mobile.defaultDialogTransition:a.mobile.defaultPageTransition);p.reverse=p.reverse||r<0;e(b,h,p.transition,p.reverse).done(function(){c();p.duplicateCachedPage&&
p.duplicateCachedPage.remove();n.removeClass("ui-mobile-rendering");f();u.trigger("changepage")})}}}};a.mobile.changePage.defaults={transition:d,reverse:!1,changeHash:!0,fromHashChange:!1,role:d,duplicateCachedPage:d,pageContainer:d,showLoadMsg:!0};a.mobile._registerInternalEvents=function(){a("form").live("submit",function(b){var c=a(this);if(a.mobile.ajaxEnabled&&!c.is(":jqmData(ajax='false')")){var d=c.attr("method"),f=c.attr("target"),e=c.attr("action");if(!e&&(e=o(c),e===p.hrefNoHash))e=u.hrefNoSearch;
e=i.makeUrlAbsolute(e,o(c));!i.isExternal(e)&&!f&&(a.mobile.changePage(e,{type:d&&d.length&&d.toLowerCase()||"get",data:c.serialize(),transition:c.jqmData("transition"),direction:c.jqmData("direction"),reloadPage:!0}),b.preventDefault())}});a(document).bind("vclick",function(b){if((b=k(b.target))&&i.parseUrl(b.getAttribute("href")||"#").hash!=="#")c(!0),q=a(b).closest(".ui-btn").not(".ui-disabled"),q.addClass(a.mobile.activeBtnClass),a("."+a.mobile.activePageClass+" .ui-btn").not(b).blur()});a(document).bind("click",
function(b){var e=k(b.target);if(e){var f=a(e),g=function(){window.setTimeout(function(){c(!0)},200)};if(f.is(":jqmData(rel='back')"))return window.history.back(),!1;if(a.mobile.ajaxEnabled){var h=o(f),e=i.makeUrlAbsolute(f.attr("href")||"#",h);if(e.search("#")!=-1)if(e=e.replace(/[^#]*#/,""))e=i.isPath(e)?i.makeUrlAbsolute(e,h):i.makeUrlAbsolute("#"+e,u.hrefNoHash);else{b.preventDefault();return}var h=f.is("[rel='external']")||f.is(":jqmData(ajax='false')")||f.is("[target]"),s=a.mobile.allowCrossDomainPages&&
u.protocol==="file:"&&e.search(/^https?:/)!=-1;h||i.isExternal(e)&&!s?g():(g=f.jqmData("transition"),h=(h=f.jqmData("direction"))&&h==="reverse"||f.jqmData("back"),f=f.attr("data-"+a.mobile.ns+"rel")||d,a.mobile.changePage(e,{transition:g,reverse:h,role:f}),b.preventDefault())}else g()}});a(".ui-page").live("pageshow.prefetch",function(){var b=[];a(this).find("a:jqmData(prefetch)").each(function(){var c=a(this).attr("href");c&&a.inArray(c,b)===-1&&(b.push(c),a.mobile.loadPage(c))})});a.mobile._handleHashChange=
function(b){var c=i.stripHash(b),e={transition:a.mobile.urlHistory.stack.length===0?"none":d,changeHash:!1,fromHashChange:!0};if(!a.mobile.hashListeningEnabled||m.ignoreNextHashChange)m.ignoreNextHashChange=!1;else{if(m.stack.length>1&&c.indexOf(v)>-1)if(a.mobile.activePage.is(".ui-dialog"))m.directHashChange({currentUrl:c,either:function(b){var d=a.mobile.urlHistory.getActive();c=d.pageUrl;a.extend(e,{role:d.role,transition:d.transition,reverse:b})}});else{m.directHashChange({currentUrl:c,isBack:function(){window.history.back()},
isForward:function(){window.history.forward()}});return}c?(c=typeof c==="string"&&!i.isPath(c)?"#"+c:c,a.mobile.changePage(c,e)):a.mobile.changePage(a.mobile.firstPage,e)}};r.bind("hashchange",function(){a.mobile._handleHashChange(location.hash)});a(document).bind("pageshow",h);a(window).bind("throttledresize",h)}})(jQuery);
...
!0;a.mobile.path.isPath(location.hash)&&(d=b.state(),c=a.mobile.path.makeUrlAbsolute(d.hash.replace("#",""),location.href),c=b.resetUIKeys(c),history.replaceState(d,document.title,c))},onPopState:function(b){var c=b.originalEvent.state;if(c)a.mobile.urlHistory.ignoreNextHashChange=!0,setTimeout(function(){a.mobile.urlHistory.ignoreNextHashChange=!1;a.mobile._handleHashChange(c.hash)})},init:function(){c.bind("hashchange",b.onHashChange);c.bind("popstate",b.onPopState);location.hash===""&&history.replaceState(b.state(),
...
c=a.last().addClass("ui-corner-bottom"),c.add(c.find(".ui-btn-inner")).find(".ui-li-link-alt").addClass("ui-corner-br").end().find(".ui-li-thumb").addClass("ui-corner-bl"))},refresh:function(b){this.parentPage=this.element.closest(".ui-page");this._createSubPages();var c=this.options,d=this.element,e=d.jqmData("dividertheme")||c.dividerTheme,g=d.jqmData("splittheme"),h=d.jqmData("spliticon"),j=d.children("li"),k=a.support.cssPseudoElement||!a.nodeName(d[0],"ol")?0:1,o,r,n,l,i;k&&d.find(".ui-li-dec").remove();
for(var q=0,m=j.length;q<m;q++){o=j.eq(q);r="ui-li";if(b||!o.hasClass("ui-li"))n=o.jqmData("theme")||c.theme,l=o.children("a"),l.length?(i=o.jqmData("icon"),o.buttonMarkup({wrapperEls:"div",shadow:!1,corners:!1,iconpos:"right",icon:l.length>1||i===!1?!1:i||"arrow-r",theme:n}),i!=!1&&l.length==1&&o.addClass("ui-li-has-arrow"),l.first().addClass("ui-link-inherit"),l.length>1&&(r+=" ui-li-has-alt",l=l.last(),i=g||l.jqmData("theme")||c.splitTheme,l.appendTo(o).attr("title",l.text()).addClass("ui-li-link-alt").empty().buttonMarkup({shadow:!1,
corners:!1,theme:n,icon:!1,iconpos:!1}).find(".ui-btn-inner").append(a("<span />").buttonMarkup({shadow:!0,corners:!0,theme:i,iconpos:"notext",icon:h||l.jqmData("icon")||c.splitIcon})))):o.jqmData("role")==="list-divider"?(r+=" ui-li-divider ui-btn ui-bar-"+e,o.attr("role","heading"),k&&(k=1)):r+=" ui-li-static ui-body-"+n;k&&r.indexOf("ui-li-divider")<0&&(n=o.is(".ui-li-static:first")?o:o.find(".ui-link-inherit"),n.addClass("ui-li-jsnumbering").prepend("<span class='ui-li-dec'>"+k++ +". </span>"));
o.add(o.children(".ui-btn-inner")).addClass(r);this._itemApply(d,o)}this._refreshCorners(b)},_idStringEscape:function(a){return a.replace(/[^a-zA-Z0-9]/g,"-")},_createSubPages:function(){var b=this.element,c=b.closest(".ui-page"),f=c.jqmData("url"),e=f||c[0][a.expando],g=b.attr("id"),h=this.options,j="data-"+a.mobile.ns,k=this,o=c.find(":jqmData(role='footer')").jqmData("id"),r;typeof d[e]==="undefined"&&(d[e]=-1);g=g||++d[e];a(b.find("li>ul, li>ol").toArray().reverse()).each(function(c){var d=a(this),
e=d.attr("id")||g+"-"+c,c=d.parent(),k=a(d.prevAll().toArray().reverse()),k=k.length?k:a("<span>"+a.trim(c.contents()[0].nodeValue)+"</span>"),m=k.first().text(),e=(f||"")+"&"+a.mobile.subPageUrlKey+"="+e,x=d.jqmData("theme")||h.theme,z=d.jqmData("counttheme")||b.jqmData("counttheme")||h.countTheme;r=!0;d.detach().wrap("<div "+j+"role='page' "+j+"url='"+e+"' "+j+"theme='"+x+"' "+j+"count-theme='"+z+"'><div "+j+"role='content'></div></div>").parent().before("<div "+j+"role='header' "+j+"theme='"+h.headerTheme+
"'><div class='ui-title'>"+m+"</div></div>").after(o?a("<div "+j+"role='footer' "+j+"id='"+o+"'>"):"").parent().appendTo(a.mobile.pageContainer).page();d=c.find("a:first");d.length||(d=a("<a/>").html(k||m).prependTo(c.empty()));d.attr("href","#"+e)}).listview();r&&c.data("page").options.domCache===!1&&c.unbind("pagehide.remove").bind("pagehide.remove",function(b,d){var e=d.nextPage;d.nextPage&&(e=e.jqmData("url"),e.indexOf(f+"&"+a.mobile.subPageUrlKey)!==0&&(k.childPages().remove(),c.remove()))})},
...
"",j=c.attr("id"),k=j+"-label",j=a("[for='"+j+"']").attr("id",k),o=function(){return h=="input"?parseFloat(c.val()):c[0].selectedIndex},r=h=="input"?parseFloat(c.attr("min")):0,n=h=="input"?parseFloat(c.attr("max")):c.find("option").length-1,l=window.parseFloat(c.attr("step")||1),i=a("<div class='ui-slider "+f+" ui-btn-down-"+g+" ui-btn-corner-all' role='application'></div>"),q=a("<a href='#' class='ui-slider-handle'></a>").appendTo(i).buttonMarkup({corners:!0,theme:e,shadow:!0}).attr({role:"slider",
"aria-valuemin":r,"aria-valuemax":n,"aria-valuenow":o(),"aria-valuetext":o(),title:o(),"aria-labelledby":k});a.extend(this,{slider:i,handle:q,dragging:!1,beforeStart:null,userModified:!1});h=="select"&&(i.wrapInner("<div class='ui-slider-inneroffset'></div>"),c.find("option"),c.find("option").each(function(b){var c=!b?"b":"a",d=!b?"right":"left",b=!b?" ui-btn-down-"+g:" "+a.mobile.activeBtnClass;a("<div class='ui-slider-labelbg ui-slider-labelbg-"+c+b+" ui-btn-corner-"+d+"'></div>").prependTo(i);
a("<span class='ui-slider-label ui-slider-label-"+c+b+" ui-btn-corner-"+d+"' role='img'>"+a(this).text()+"</span>").prependTo(q)}));j.addClass("ui-slider");c.addClass(h==="input"?"ui-slider-input":"ui-slider-switch").change(function(){b.refresh(o(),!0)}).keyup(function(){b.refresh(o(),!0,!0)}).blur(function(){b.refresh(o(),!0)});a(document).bind("vmousemove",function(a){if(b.dragging)return b.refresh(a),b.userModified=b.userModified||b.beforeStart!==c[0].selectedIndex,!1});i.bind("vmousedown",function(a){b.dragging=
!0;b.userModified=!1;if(h==="select")b.beforeStart=c[0].selectedIndex;b.refresh(a);return!1});i.add(document).bind("vmouseup",function(){if(b.dragging)return b.dragging=!1,h==="select"&&!b.userModified&&(q.addClass("ui-slider-handle-snapping"),b.refresh(!b.beforeStart?1:0)),!1});i.insertAfter(c);this.handle.bind("vmousedown",function(){a(this).focus()}).bind("vclick",!1);this.handle.bind("keydown",function(c){var d=o();if(!b.options.disabled){switch(c.keyCode){case a.mobile.keyCode.HOME:case a.mobile.keyCode.END:case a.mobile.keyCode.PAGE_UP:case a.mobile.keyCode.PAGE_DOWN:case a.mobile.keyCode.UP:case a.mobile.keyCode.RIGHT:case a.mobile.keyCode.DOWN:case a.mobile.keyCode.LEFT:if(c.preventDefault(),
!b._keySliding)b._keySliding=!0,a(this).addClass("ui-state-active")}switch(c.keyCode){case a.mobile.keyCode.HOME:b.refresh(r);break;case a.mobile.keyCode.END:b.refresh(n);break;case a.mobile.keyCode.PAGE_UP:case a.mobile.keyCode.UP:case a.mobile.keyCode.RIGHT:b.refresh(d+l);break;case a.mobile.keyCode.PAGE_DOWN:case a.mobile.keyCode.DOWN:case a.mobile.keyCode.LEFT:b.refresh(d-l)}}}).keyup(function(){if(b._keySliding)b._keySliding=!1,a(this).removeClass("ui-state-active")});this.refresh(d,d,!0)},refresh:function(a,
...
(function(a){var d=function(b){var c=b.selectID,d=b.label,e=b.select.closest(".ui-page"),g=a("<div>",{"class":"ui-selectmenu-screen ui-screen-hidden"}).appendTo(e),h=b.select.find("option"),j=b.isMultiple=b.select[0].multiple,k=c+"-button",o=c+"-menu",r=a("<div data-"+a.mobile.ns+"role='dialog' data-"+a.mobile.ns+"theme='"+b.options.menuPageTheme+"'><div data-"+a.mobile.ns+"role='header'><div class='ui-title'>"+d.text()+"</div></div><div data-"+a.mobile.ns+"role='content'></div></div>").appendTo(a.mobile.pageContainer).page(),
n=a("<div>",{"class":"ui-selectmenu ui-selectmenu-hidden ui-overlay-shadow ui-corner-all ui-body-"+b.options.overlayTheme+" "+a.mobile.defaultDialogTransition}).insertAfter(g),l=a("<ul>",{"class":"ui-selectmenu-list",id:o,role:"listbox","aria-labelledby":k}).attr("data-"+a.mobile.ns+"theme",b.options.theme).appendTo(n),i=a("<div>",{"class":"ui-header ui-bar-"+b.options.theme}).prependTo(n),q=a("<h1>",{"class":"ui-title"}).appendTo(i),m=a("<a>",{text:b.options.closeText,href:"#","class":"ui-btn-left"}).attr("data-"+
a.mobile.ns+"iconpos","notext").attr("data-"+a.mobile.ns+"icon","delete").appendTo(i).buttonMarkup(),x=r.find(".ui-content"),z=r.find(".ui-header a");a.extend(b,{select:b.select,selectID:c,buttonId:k,menuId:o,thisPage:e,menuPage:r,label:d,screen:g,selectOptions:h,isMultiple:j,theme:b.options.theme,listbox:n,list:l,header:i,headerTitle:q,headerClose:m,menuPageContent:x,menuPageClose:z,placeholder:"",build:function(){var b=this;b.refresh();b.select.attr("tabindex","-1").focus(function(){a(this).blur();
...
var i=f-e,n=e+g-f,j=c/2,l=parseFloat(b.list.parent().css("max-width")),c=i>c/2&&n>c/2?f+b.button.outerHeight()/2-j:i>n?e+g-c-30:e+30;d<l?l=(h-d)/2:(l=b.button.offset().left+b.button.outerWidth()/2-d/2,l<30?l=30:l+d>h&&(l=h-d-30));b.listbox.append(b.list).removeClass("ui-selectmenu-hidden").css({top:c,left:l}).addClass("in");b.list.find(a.mobile.activeBtnClass).focus();b.isOpen=!0}}},_buildList:function(){var b=this,c=this.options,d=this.placeholder,e=[],f=[],g=b.isMultiple?"checkbox-off":"false";
b.list.empty().filter(".ui-listview").listview("destroy");b.select.find("option").each(function(h){var i=a(this),n=i.parent(),l=i.text(),j="<a href='#'>"+l+"</a>",k=[],m=[];n.is("optgroup")&&(n=n.attr("label"),a.inArray(n,e)===-1&&(f.push("<li data-"+a.mobile.ns+"role='list-divider'>"+n+"</li>"),e.push(n)));if(!this.getAttribute("value")||l.length==0||i.jqmData("placeholder"))c.hidePlaceholderMenuItems&&k.push("ui-selectmenu-placeholder"),d=b.placeholder=l;this.disabled&&(k.push("ui-disabled"),m.push("aria-disabled='true'"));
f.push("<li data-"+a.mobile.ns+"option-index='"+h+"' data-"+a.mobile.ns+"icon='"+g+"' class='"+k.join(" ")+"' "+m.join(" ")+">"+j+"</li>")});b.list.html(f.join(" "));b.list.find("li").attr({role:"option",tabindex:"-1"}).first().attr("tabindex","0");this.isMultiple||this.headerClose.hide();!this.isMultiple&&!d.length?this.header.hide():this.headerTitle.text(this.placeholder);b.list.listview()},_button:function(){return a("<a>",{href:"#",role:"button",id:this.buttonId,"aria-haspopup":"true","aria-owns":this.menuId})}})};
...
function c(a){var b=0,c,d;if(a){d=document.body;c=a.offsetParent;for(b=a.offsetTop;a&&a!=d;){b+=a.scrollTop||0;if(a==c)b+=c.offsetTop,c=a.offsetParent;a=a.parentNode}}return b}function f(b){var d=a(window).scrollTop(),e=c(b[0]),f=b.css("top")=="auto"?0:parseFloat(b.css("top")),g=window.innerHeight,h=b.outerHeight(),j=b.parents(".ui-page:not(.ui-page-fullscreen)").length;return b.is(".ui-header-fixed")?(f=d-e+f,f<e&&(f=0),b.css("top",j?f:d)):b.css("top",j?d+g-h-(e-f):d+g-h)}if(a.support.scrollTop){var e,
g,h="inline",j=!1,k=null,o=!1,r=!0;a(function(){var c=a(document),d=a(window);c.bind("vmousedown",function(){r&&(k=h)}).bind("vclick",function(b){r&&!a(b.target).closest("a,input,textarea,select,button,label,.ui-header-fixed,.ui-footer-fixed").length&&!o&&(a.mobile.fixedToolbars.toggle(k),k=null)}).bind("silentscroll",b);(c.scrollTop()===0?d:c).bind("scrollstart",function(){o=!0;k===null&&(k=h);var b=k=="overlay";if(j=b||!!g)a.mobile.fixedToolbars.clearShowTimer(),b&&a.mobile.fixedToolbars.hide(!0)}).bind("scrollstop",
function(b){a(b.target).closest("a,input,textarea,select,button,label,.ui-header-fixed,.ui-footer-fixed").length||(o=!1,j&&(a.mobile.fixedToolbars.startShowTimer(),j=!1),k=null)});d.bind("resize",b)});a(".ui-page").live("pagebeforeshow",function(b,c){var d=a(b.target).find(":jqmData(role='footer')"),g=d.data("id"),h=c.prevPage,h=h&&h.find(":jqmData(role='footer')"),h=h.length&&h.jqmData("id")===g;g&&h&&(e=d,f(e.removeClass("fade in out").appendTo(a.mobile.pageContainer)))}).live("pageshow",function(){var b=
a(this);e&&e.length&&setTimeout(function(){f(e.appendTo(b).addClass("fade"));e=null},500);a.mobile.fixedToolbars.show(!0,this)});a(".ui-collapsible-contain").live("collapse expand",b);return{show:function(b,d){a.mobile.fixedToolbars.clearShowTimer();h="overlay";return(d?a(d):a.mobile.activePage?a.mobile.activePage:a(".ui-page-active")).children(".ui-header-fixed:first, .ui-footer-fixed:not(.ui-footer-duplicate):last").each(function(){var d=a(this),e=a(window).scrollTop(),g=c(d[0]),h=window.innerHeight,
j=d.outerHeight(),e=d.is(".ui-header-fixed")&&e<=g+j||d.is(".ui-footer-fixed")&&g<=e+h;d.addClass("ui-fixed-overlay").removeClass("ui-fixed-inline");!e&&!b&&d.animationComplete(function(){d.removeClass("in")}).addClass("in");f(d)})},hide:function(b){h="inline";return(a.mobile.activePage?a.mobile.activePage:a(".ui-page-active")).children(".ui-header-fixed:first, .ui-footer-fixed:not(.ui-footer-duplicate):last").each(function(){var c=a(this),d=c.css("top"),d=d=="auto"?0:parseFloat(d);c.addClass("ui-fixed-inline").removeClass("ui-fixed-overlay");
...
a.mobile.fixedToolbars.show()},setTouchToggleEnabled:function(a){r=a}}}}();a.fixedToolbars=a.mobile.fixedToolbars;a(document).bind("pagecreate create",function(b){a(":jqmData(position='fixed')",b.target).length&&a(b.target).each(function(){if(!a.support.scrollTop)return this;var b=a(this);b.jqmData("fullscreen")&&b.addClass("ui-page-fullscreen");b.find(".ui-header:jqmData(position='fixed')").addClass("ui-header-fixed ui-fixed-inline fade");b.find(".ui-footer:jqmData(position='fixed')").addClass("ui-footer-fixed ui-fixed-inline fade")})})})(jQuery);
...
location.pathname)});a.mobile.firstPage=b.first();a.mobile.pageContainer=b.first().parent().addClass("ui-mobile-viewport");a.mobile.showPageLoadingMsg();!a.mobile.hashListeningEnabled||!a.mobile.path.stripHash(location.hash)?a.mobile.changePage(a.mobile.firstPage,{transition:"none",reverse:!0,changeHash:!1,fromHashChange:!0}):c.trigger("hashchange",[!0])}});a.mobile._registerInternalEvents();a(function(){d.scrollTo(0,1);a.mobile.defaultHomeScroll=!a.support.scrollTop||a(d).scrollTop()===1?0:1;a.mobile.autoInitializePage&&
a.mobile.initializePage();c.load(a.mobile.silentScroll)})}})(jQuery,this);
